...
public class PublicProfileSettings {
    ...
    public PublicProfileSettings() {
        ...
        this.language = (ModeValue)ModeValue.create((Object)this, "Language", FontSelector.j,
                FontSelector.j, FontSelector.c, FontSelector.S, FontSelector.a,
                FontSelector.P).setResettable(false);
