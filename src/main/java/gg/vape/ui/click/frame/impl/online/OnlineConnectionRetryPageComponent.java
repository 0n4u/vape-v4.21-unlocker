...
extends OnlineConnectionSettingsPageComponent {
    ...
    public void c() {
        ...
        if (reconnectAt != -1L) {
            ...
            this.getAlternateFontRenderer(0.8).W("Reconnecting, " + remainingSeconds + "s left...", this.G$src$D$1b2f02a() + this.A() / 2.0, this.n() + 52.0, OnlineConnectionRetryPageComponent.J.A);
        } else {
